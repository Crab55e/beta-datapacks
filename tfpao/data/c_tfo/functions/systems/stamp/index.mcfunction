...
execute if entity @s[scores={stamp=25}] run tellraw @a ["スタンプ :\n\n\n\n\uE024\n\nby ",{"selector":"@s"}]
execute if entity @s[scores={stamp=26}] run tellraw @a ["スタンプ :\n\n\n\n\uE025\n\nby ",{"selector":"@s"}]
execute if entity @s[scores={stamp=27}] run tellraw @a ["スタンプ :\n\n\n\n\uE026\n\nby ",{"selector":"@s"}]
execute if entity @s[scores={stamp=28}] run tellraw @a ["スタンプ :\n\n\n\n\uE027\n\nby ",{"selector":"@s"}]
execute if entity @s[scores={stamp=29}] run tellraw @a ["スタンプ :\n\n\n\n\uE028\n\nby ",{"selector":"@s"}]
execute if entity @s[scores={stamp=30}] run tellraw @a ["スタンプ :\n\n\n\n\uE029\n\nby ",{"selector":"@s"}]
execute if entity @s[scores={stamp=31}] run tellraw @a ["スタンプ :\n\n\n\n\uE030\n\nby ",{"selector":"@s"}]
